        ...
        fun bind(hero: Hero) {
            with(itemView) {
                ...
                btn_set_favorite.setOnClickListener {
                    Toast.makeText(itemView.context, "Kamu telah menambahkan ${hero.name} ke Favorite", Toast.LENGTH_SHORT).show()
                }
                btn_set_share.setOnClickListener {
                    Toast.makeText(itemView.context, "${hero.name} Telah kamu share", Toast.LENGTH_SHORT).show()
                }
                itemView.setOnClickListener { Toast.makeText(itemView.context, "Kamu telah memilih ${hero.name}", Toast.LENGTH_SHORT).show() }
            }
            itemView.setOnClickListener { Toast.makeText(itemView.context, "Kamu telah memilih ${hero.name}", Toast.LENGTH_SHORT).show() }
        }
    }
